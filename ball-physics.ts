...
export class BallEntity {
  ...
  constructor(scene: Phaser.Scene, x: number, y: number) {
    this.sprite = scene.matter.add.sprite(x, y, "", undefined, {
      ...
      frictionAir: 0,
      // Matter uses the greater restitution of the collision pair. The ball
      // therefore carries the player value; walls carry the wall value.
      restitution: PHYSICS.ballRestitutionPlayer,
      collisionFilter: {
