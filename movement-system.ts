...
export function stepPlayerVelocity(
  ...
  const retainedVelocity = inputX !== 0 || inputY !== 0 ? damping : brakeDamping;
  let vx = currentVx * retainedVelocity + inputX * accelPerTick;
  let vy = currentVy * retainedVelocity + inputY * accelPerTick;
